...
@CompileStatic
abstract class MDGExtensionOld {
    @PackageScope static final String NAME = 'modsDotGroovyOld'
    ...
    @Inject
    MDGExtensionOld(final Project project, final ObjectFactory objectFactory) {
