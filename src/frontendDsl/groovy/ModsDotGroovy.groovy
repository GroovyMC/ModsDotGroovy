 ...
 * - Holding the backingData Map
 * - Providing basic validation that can be customized by plugins
 * - Providing reasonable defaults for the backingData
 ...
 *       Quilt-specific backingData when they're only using Forge
